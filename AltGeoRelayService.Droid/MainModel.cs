...
namespace AltGeoRelayService.Droid
{
    partial class MainModel : IDisposable
    {
        ...
        internal string ConnectedDeviceId { get; private set; }
        internal string ConnectedDeviceName { get; private set; }
        ...
        private void Connect()
        {
            ...
            if (licensed)
            {
                ConnectedDeviceId = serialNumber;
                ConnectedDeviceName = instrumentName;
