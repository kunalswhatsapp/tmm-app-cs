...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("a.k, Trimble.Ssi.DriverManagement.NET", k.class, __md_methods);
	}
	...
	public k ()
	{
		super ();
		if (getClass () == k.class) {
			mono.android.TypeManager.Activate ("a.k, Trimble.Ssi.DriverManagement.NET", "", this, new java.lang.Object[] {  });
		}
	}
	...
	public k (android.content.Context p0)
	{
		super ();
		if (getClass () == k.class) {
			mono.android.TypeManager.Activate ("a.k, Trimble.Ssi.DriverManagement.NET", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
		}
	}
