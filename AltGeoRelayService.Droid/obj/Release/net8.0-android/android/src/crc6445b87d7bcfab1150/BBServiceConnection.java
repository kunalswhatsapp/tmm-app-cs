package crc6445b87d7bcfab1150;


public class BBServiceConnection
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Trimble.Ssi.Driver.AndroidService.Driver.Catalyst.Android.BBService.BBServiceConnection, Trimble.Ssi.Driver.AndroidService.Driver.Catalyst.NET.Android", BBServiceConnection.class, __md_methods);
	}


	public BBServiceConnection ()
	{
		super ();
		if (getClass () == BBServiceConnection.class) {
			mono.android.TypeManager.Activate ("Trimble.Ssi.Driver.AndroidService.Driver.Catalyst.Android.BBService.BBServiceConnection, Trimble.Ssi.Driver.AndroidService.Driver.Catalyst.NET.Android", "", this, new java.lang.Object[] {  });
		}
	}
